...
<head>
    ...
    <script>
        ...
        window.chrome.webview.addEventListener('message', arg =>
		{
            ...
            {
                document.getElementById('loginMessage').innerHTML = arg.data;
            }
            else
            {
				// handle JSON
		...
		function HandlePasswordCheck()
		{
			if (passwordCheck.readyState == 4 && passwordCheck.status == 200)
			{
				...
				window.chrome.webview.postMessage(passwordCheck.responseText);
			}
		}
        ...
        function ValidateLogin()
		{
			...
			var url = 'http://127.0.0.1:26105/xmlFormatters/getLogin.php?userId=' + uname + '&password=' + psw;
...
<body>
    ...
    <form action="javascript:;" onsubmit="ValidateLogin(this);">
